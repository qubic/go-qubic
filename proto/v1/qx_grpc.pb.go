...
func (c *qxServiceClient) GetFees(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Fees, error) {
	...
	out := new(Fees)
	err := c.cc.Invoke(ctx, QxService_GetFees_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qxServiceClient) GetAssetAskOrders(ctx context.Context, in *GetAssetOrdersRequest, opts ...grpc.CallOption) (*AssetOrders, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssetOrders)
	err := c.cc.Invoke(ctx, QxService_GetAssetAskOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qxServiceClient) GetAssetBidOrders(ctx context.Context, in *GetAssetOrdersRequest, opts ...grpc.CallOption) (*AssetOrders, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssetOrders)
	err := c.cc.Invoke(ctx, QxService_GetAssetBidOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qxServiceClient) GetEntityAskOrders(ctx context.Context, in *GetEntityOrdersRequest, opts ...grpc.CallOption) (*EntityOrders, error) {
	...
	err := c.cc.Invoke(ctx, QxService_GetEntityAskOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qxServiceClient) GetEntityBidOrders(ctx context.Context, in *GetEntityOrdersRequest, opts ...grpc.CallOption) (*EntityOrders, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EntityOrders)
	err := c.cc.Invoke(ctx, QxService_GetEntityBidOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedQxServiceServer must be embedded to have
...
func RegisterQxServiceServer(s grpc.ServiceRegistrar, srv QxServiceServer) {
	// If the following call panics, it indicates UnimplementedQxServiceServer was
